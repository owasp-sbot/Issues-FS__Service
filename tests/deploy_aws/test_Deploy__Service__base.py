...
from issues_fs_service.config                                                import LAMBDA_DEPENDENCIES__ISSUES_FS_SERVICE
from issues_fs_service.utils.deploy.Deploy__Service                          import Deploy__Service
...
class test_Deploy__Service__base():     # Base class for deployment tests - override stage in subclasses
    ...
    def test_2__upload_dependencies(self):
        ...
        assert list_set(upload_results) == LAMBDA_DEPENDENCIES__ISSUES_FS_SERVICE
