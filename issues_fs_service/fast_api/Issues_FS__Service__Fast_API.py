# ═══════════════════════════════════════════════════════════════════════════════
# Issues_FS__Service__Fast_API - Main FastAPI application
...
from issues_fs_service.config                                                                    import FAST_API__TITLE, FAST_API__DESCRIPTION
from issues_fs_service.utils.Version                                                             import version__issues_fs_service
...
class Issues_FS__Service__Fast_API(Serverless__Fast_API):
    ...
    def setup(self):
        with self.config as _:
            ...
            _.version        = version__issues_fs_service
